...
class Packet
{
  ...
  public:
    Packet()
        : m_payload(), m_timestamp( 0 ), m_network_port_address(), m_source_address(), m_destination_address(), m_protocol( 0 )
    {
    }
    ...
    PacketPayload const &set_payload() const
    {
        return m_payload;
    }
    ...
    void set_source_address( Address const &a )
    {
        m_source_address = a;
    }
