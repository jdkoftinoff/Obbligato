#pragma once
#ifndef Obbligato_SIMD_VectorSSE32x4_hpp
#define Obbligato_SIMD_VectorSSE32x4_hpp
...
template <> class OBBLIGATO_PLATFORM_VECTOR_ALIGN SIMD_Vector<float, 4> {
  public:
    ...
    SIMD_Vector(value_type p1) { m_vec = _mm_set1_ps(p1); }
    ...
    void zero() { m_vec = _mm_set1_ps(0.0f); }
