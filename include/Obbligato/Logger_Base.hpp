...
#define ob_cdebug ::Obbligato::logger->cdebug() << __FILE__ << ":" << __LINE__ << ":"
#define ob_ctrace ::Obbligato::logger->ctrace() << __FILE__ << ":" << __LINE__ << ":"
    ...
    namespace Logger
    {
        ...
        public:
            LoggerBase() :
                ...
                m_cdebug_buf(this),
                m_ctrace_buf(this),
                m_cerror( &m_cerror_buf ),
                m_cwarning( &m_cwarning_buf ),
                m_cinfo( &m_cinfo_buf ),
                m_cdebug( &m_cdebug_buf ),
                m_ctrace( &m_ctrace_buf )
            {
            }
