...
namespace Obbligato
{
    namespace SIMD
    {
        ...
        public:
            ...
            SIMD_Vector(value_type const &p1, value_type const &p2, value_type const &p3, value_type const &p4)
            {
                m_item[0] = p1;
                m_item[1] = p2;
                m_item[2] = p3;
            ...
            SIMD_Vector(value_type const &p1, value_type const &p2, value_type const &p3, value_type const &p4,
                        value_type const &p5, value_type const &p6, value_type const &p7, value_type const &p8)
            {
                m_item[0] = p1;
                m_item[1] = p2;
                m_item[2] = p3;
        ...
        template <typename T>
        typename T::simd_type::value_type get( T &v, size_t pos )
        {
            return v.get(pos);
        }

        template <typename T>
        void set(T &d, T &v, size_t pos=0)
        {
            if( pos!=0 )
            {
                throw std::range_error("pos!=0 for non-vector get");
        ...
        inline std::basic_ostream< CharT, TraitsT> & operator << ( std::basic_ostream< CharT, TraitsT> &str, SIMD_Vector<T, N> const &a )
        {
            str << "{ ";
        ...
        template <typename T,size_t N>
        inline SIMD_Vector<T,N> operator < (SIMD_Vector<T, N> const &a, SIMD_Vector<T, N> const &b )
        {
            SIMD_Vector<T, N> r;
