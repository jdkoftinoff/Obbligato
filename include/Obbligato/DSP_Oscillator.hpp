...
struct Oscillator
{
    ...
    struct State
    {
        ...
        void setFrequency( float sample_rate_recip,
                           ...
                           size_t channel )
        {
            float w = static_cast<float>( OBBLIGATO_TWO_PI ) * frequency
                      * sample_rate_recip;
        ...
        void setFrequency( double sample_rate_recip,
                           double frequency,
                           double phase_in_radians,
                           size_t channel )
        {
                               ...
                               size_t channel = 0 )
        {
            double tuning_multiplier
                = pow( 2.0, tuning_in_cents * ( 1.0 / 1200.0 ) );
            ...
            double freq = oscillator_note_frequencies_a440[note]
                          ...
                          * a_tuning_multipler;
            setFrequency(
                sample_rate_recip, freq, phase_in_radians, channel );
        }
        ...
        void setFrequencyNote( float sample_rate_recip,
                               ...
                               size_t channel = 0 )
        {
            float tuning_multiplier
                = powf( 2.0f, tuning_in_cents * ( 1.0f / 1200.0f ) );
            float octave_multiplier
                = oscillator_octave_multiplier_table_f[octave];
