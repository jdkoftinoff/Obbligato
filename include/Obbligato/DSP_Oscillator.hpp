...
struct Oscillator {
    ...
    struct State {
        ...
        void set_frequency( double sample_rate, double frequency, double phase_in_radians, size_t channel=0 ) {
        ...
        void set_frequency_note(
                ...
                size_t channel=0 ) {
            double tuning_multiplier = (tuning_in_cents-tuning_of_a)/tuning_of_a;
            double octave_multiplier = oscillator_octave_multiplier_table[octave];
            double freq = oscillator_note_frequencies_a440[note] * tuning_multiplier * octave_multiplier;
