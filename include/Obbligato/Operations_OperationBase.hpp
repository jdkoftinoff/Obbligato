...
class OperationBase : public NotificationTarget, public Time::Ticker
{
  ...
  public:
    OperationBase( std::string const &operation_description ) : m_operation_description( operation_description )
    {
    }
    ...
    virtual void operation_add_target( NotificationTargetPtr ) = 0;
    virtual void operation_set_primary_target( NotificationTargetPtr ) = 0;
    ...
    virtual void requested_operation_in_progress( OperationID operation_id, int permil_done ) = 0;
