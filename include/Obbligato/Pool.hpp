...
namespace Obbligato
{
    ...
    private:
        ...
        /// Given a pointer to an item within the pool, figure out which item it is and call destroy_item() on it
        ...
        /// Given an item number in the pool, call the items destructor and mark the pool item as available.
        ...
        /// Find the next available slot and store the slot number as a hint for the next allocation.
        ...
        /// Find a slot that is available, mark it as allocated and return a pointer to it.
        void *allocate()
        {
            void *r=0;
        ...
        /// The 'deleter' helper class which allows a smart pointer to do the right thing to notify the pool to delete the item
        class PoolDeleter : public DeleterBase<T>
        {
        public:
            Pool<T> *m_pool;

            PoolDeleter( Pool<T> *pool )
                : m_pool( pool )
            {
            }
    ...
    public:
        ...
        /// Allocate an item from the pool and return a shared pointer to it (2 args)
        ...
        /// Allocate an item from the pool and return a shared pointer to it (3 args)
        template <typename Arg1, typename Arg2, typename Arg3>
        shared_ptr<T> make_shared( Arg1 const &arg1, Arg2 const &arg2, Arg3 const &arg3 )
        {
            return shared_ptr<T>( new( allocate() ) T(arg1,arg2,arg3), PoolDeleter(this) );
        }

        /// Allocate an item from the pool and return a shared pointer to it (4 args)
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        shared_ptr<T> make_shared( Arg1 const &arg1, Arg2 const &arg2, Arg3 const &arg3, Arg4 const &arg4 )
        {
            return shared_ptr<T>( new( allocate() ) T(arg1,arg2,arg3,arg4), PoolDeleter(this) );
        }

        /// Allocate an item from the pool and return a shared pointer to it (5 args)
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        shared_ptr<T> make_shared( Arg1 const &arg1, Arg2 const &arg2, Arg3 const &arg3, Arg4 const &arg4, Arg5 const &arg5 )
        {
            return shared_ptr<T>( new( allocate() ) T(arg1,arg2,arg3,arg4,arg5), PoolDeleter(this) );
        }

        /// Allocate an item from the pool and return a shared pointer to it (6 args)
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6>
        shared_ptr<T> make_shared( Arg1 const &arg1, Arg2 const &arg2, Arg3 const &arg3, Arg4 const &arg4, Arg5 const &arg5, Arg6 const &arg6 )
        {
            return shared_ptr<T>( new( allocate() ) T(arg1,arg2,arg3,arg4,arg5,arg6), PoolDeleter(this) );
        }
#endif
