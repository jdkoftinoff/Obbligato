...
template <size_t MaxSizeHint> inline std::string form(const char *fmt) {
...
#ifdef _MSC_VER
    if (_snprintf_s(buf, sizeof(buf) - 1, sizeof(buf) - 1, fmt, arg1) >
...
inline std::string form(const char *fmt, Arg1 const &arg1, Arg2 const &arg2) {
    char buf[MaxSizeHint];
#ifdef _MSC_VER
    if (_snprintf_s(buf, sizeof(buf) - 1, sizeof(buf) - 1, fmt, arg1, arg2) >
        static_cast<ssize_t>(sizeof(buf) - 1))
#else
...
#ifdef _MSC_VER
    if (_snprintf_s(buf, sizeof(buf) - 1, sizeof(buf) - 1, fmt, arg1, arg2,
                    arg3) > static_cast<ssize_t>(sizeof(buf) - 1))
#else
...
#ifdef _MSC_VER
    if (_snprintf_s(buf, sizeof(buf) - 1, sizeof(buf) - 1, fmt, arg1, arg2,
                    arg3, arg4) > static_cast<ssize_t>(sizeof(buf) - 1))
#else
...
inline std::string form(const char *fmt, Arg1 const &arg1, Arg2 const &arg2,
                        Arg3 const &arg3, Arg4 const &arg4, Arg5 const &arg5) {
    char buf[MaxSizeHint];
#ifdef _MSC_VER
    if (_snprintf_s(buf, sizeof(buf) - 1, sizeof(buf) - 1, fmt, arg1, arg2,
                    arg3, arg4, arg5) > static_cast<ssize_t>(sizeof(buf) - 1))
#else
        if (snprintf(buf, sizeof(buf) - 1, fmt, arg1, arg2, arg3, arg4, arg5) >
            static_cast<ssize_t>(sizeof(buf) - 1))
#endif
            {
            throw std::runtime_error("form() overflow");
...
inline std::string form(const char *fmt, Arg1 const &arg1, Arg2 const &arg2,
    ...
    if (_snprintf_s(buf, sizeof(buf) - 1, sizeof(buf) - 1, fmt, arg1, arg2,
                    arg3, arg4, arg5,
                    arg6) > static_cast<ssize_t>(sizeof(buf) - 1))
#else
        if (snprintf(buf, sizeof(buf) - 1, fmt, arg1, arg2, arg3, arg4, arg5,
                     arg6) > static_cast<ssize_t>(sizeof(buf) - 1))
#endif
